...
export const normalizeCustomer = (customer) => {
  ...
  return {
    ...
    phoneNo: customer.phoneNo || customer.phoneNumber || customer.phone || customer.mobileNo || customer.mobile || customer.contactNumber || contactInfo.phone || "",
    billingAddress: customer.billingAddress || customer.address || customer.deliveryAddress || "",
    deliveryAddress: customer.deliveryAddress || customer.address || customer.billingAddress || "",
    customerType: customer.customerType || "",
    tax: customer.tax || customer.vatNumber || customer.vat || customer.vatNo || "",
    nicNo: customer.nicNo || "",
    tinNo: customer.tinNo || "",
    vat: customer.vat || customer.vatNumber || customer.vatNo || customer.tax || "",
