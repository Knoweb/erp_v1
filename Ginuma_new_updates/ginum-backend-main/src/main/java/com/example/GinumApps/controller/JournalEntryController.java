...
public class JournalEntryController {
    ...
    @GetMapping
    public ResponseEntity<List<JournalEntry>> getJournalEntries(@PathVariable Integer companyId) {
        return ResponseEntity.ok(journalEntryService.getJournalEntriesByCompany(companyId));
    }
