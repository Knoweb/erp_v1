...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(User user) {
        // Log roles before building authorities
        if (user.getRoles() == null || user.getRoles().isEmpty()) {
            System.err.println("⚠️ WARNING: User " + user.getEmail() + " has NO ROLES in database!");
            System.err.println("   This will result in empty authorities and roles=[] in JWT token.");
        }
